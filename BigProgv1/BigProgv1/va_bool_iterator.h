...
//! @date   20.03.2017
//-----------------------------------------------------------------------------
#ifndef BIG_VA_BOOL_va_bool_iterator_H
#define BIG_VA_BOOL_va_bool_iterator_H 1
...
namespace big {
    ...
    public:
        ...
        //! @throw big::otherError If va_bool_iterator has nullptr pointer
        ...
        //! @param lhs va_bool_iterator which is left from operator
        //! @param rhs va_bool_iterator which is right from operator
        //! @throw big::otherError If va_bool_iterators have nullptr pointer
    ...
    va_bool_iterator<Y> operator-(const va_bool_iterator<Y>& lhs,
        ...
        BIG_OTHER_ERROR(!lhs.current_, "Is null");
    ...
    typename va_bool_iterator<Y>::difference_type
        ...
        BIG_OTHER_ERROR(!lhs.current_, "Lhs is null");
        BIG_OTHER_ERROR(!rhs.current_, "Rhs is null");
...
#endif // BIG_VA_BOOL_va_bool_iterator_H