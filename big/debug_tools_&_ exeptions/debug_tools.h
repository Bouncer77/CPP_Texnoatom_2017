...
//! @date   03.04.2017
//-----------------------------------------------------------------------------
#ifndef BIG_DEBUG_TOOLS_H
#define BIG_DEBUG_TOOLS_H 1

#include "exceptions.h"
#include <cassert>

//-----------------------------------------------------------------------------
//! @def BIG_ASSERT_VALID() Macro to test object integrity
//! @details Takes a pointer to an object that have functions: is_valid() and dump()
//! @details BIG_ASSERT_VALID() us if do not exist macro BIG_NDEBUG, otherwise { }
//! @throw big::invalidObject Object is not valid
//-----------------------------------------------------------------------------
#ifndef BIG_NDEBUG
#define BIG_ASSERT_VALID(p_elem) {\
    if (!((p_elem)->is_valid())) {\
...
const char               POISON<char>::value = static_cast<char>(11);
